...
@register(outgoing=True, pattern=r"^\.(?:ntikel|nkang)\s?(.)?")
async def kang(args):
    ...
    if photo:
        ...
        response = urllib.request.urlopen(
            urllib.request.Request(f"http://t.me/addstickers/nakatikel")
        )
                ...
                while "120" in x.text:
                    ...
                    if x.text == "Gagal Memilih Pack.":
                        ...
                        return await args.edit(
                            ...
                            f"\nTekan [⚡Klik Disini⚡](t.me/addstickers/nakatikel) Untuk Melihat Sticker Anda",
                            parse_mode="md",
                        )
                if is_anim:
                    await conv.send_file("AnimatedSticker.tgs")
