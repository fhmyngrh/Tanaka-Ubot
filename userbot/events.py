        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    text = "**ZELDA-USERBOT ERROR REPORT**\n\n"
                    link = "[Group Support](https://t.me/UnrealBabies)"
                    text += "Jika mau, Anda bisa melaporkan error ini, "
                    text += f"Cukup forward saja pesan ini ke @UnrealZelda.\n\n"
                    ...
                    ftext += "\ncukup forward saja pesan ini ke @UnrealZelda"
                    ftext += "\n================================\n\n"
